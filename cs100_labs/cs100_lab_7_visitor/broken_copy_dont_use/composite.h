...
public:
    ...
    double evaluate() override = 0;	//Note: this is implicit in the inheritance, but can also be made explicit
    Iterator* create_iterator() override;
};
...
public:
    ...
    Base* get_left() override;
    Base* get_right() override;  // we dont need this for UnaryOperator, right?
    double evaluate() override = 0;	//Note: this is implicit in the inheritance, but can also be made explicit
    Iterator* create_iterator() override;
};
