...
void Op::accept(Visitor *visitor) { visitor->opNode(this); }
...
void Add::accept(Visitor *visitor) { visitor->addNode(); }
...
void Sub::accept(Visitor *visitor) { visitor->subNode(); }
...
void Mult::accept(Visitor *visitor) { visitor->multNode(); }
...
void Sqr::accept(Visitor *visitor) { visitor->sqrNode(); }
...
void Root::accept(Visitor *visitor) { visitor->rootNode(); }
